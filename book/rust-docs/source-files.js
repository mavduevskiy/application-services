...
sourcesIndex["push"] = {"name":"","dirs":[{"name":"internal","dirs":[{"name":"communications","files":["rate_limiter.rs"]},{"name":"storage","files":["db.rs","mod.rs","record.rs","schema.rs","types.rs"]}],"files":["communications.rs","config.rs","crypto.rs","error.rs","mod.rs","subscriber.rs"]}],"files":["lib.rs"]};
